                            ...
                            <>
                                {!codeSent ? (
                                    ...
                                    <>
                                        ...
                                        {/* Delivery Method Selection - faqat codeSent bo'lganda ko'rinadi */}
                                        {codeSent && (
                                            <Box sx={{ mb: 2 }}>
                                                <Typography
                                                    sx={{
                                            ...
                                            <FormControl component="fieldset">
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        />
                                                        <Collapse in={btsOpen} timeout={{ enter: 200, exit: 500 }}>
                                                            <Box sx={{ pt: 2, pl: 2 }}>
                                                                <Typography
                                                                    sx={{
                                                                        fontSize: "14px",
                                                    ...
                                                    >
                                                        ...
                                                        />
                                                        <Collapse in={yandexOpen} timeout={{ enter: 200, exit: 500 }}>
                                                            <Box sx={{ pt: 2, pl: 2 }}>
                                                                <Typography
                                                                    sx={{
                                                                        fontSize: "14px",
